<?php
class Idem_Slider_Block_Adminhtml_Slider_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid 
{
    ...
    protected function _prepareCollection() 
    {
        ...
        if ($this->getSlider()->getId()){
            $constraint = '{{table}}.slide_id='.$this->getSlider()->getId();
        }
        else{
            $constraint = '{{table}}.slide_id=0';
        }
